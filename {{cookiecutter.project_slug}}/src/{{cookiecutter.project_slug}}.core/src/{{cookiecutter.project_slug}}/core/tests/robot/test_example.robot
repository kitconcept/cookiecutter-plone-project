...
#
#  $ bin/test -s {{cookiecutter.project_slug}}.core -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src {{cookiecutter.project_slug}}.core.testing.{{cookiecutter.project_slug.capitalize()}}_CORE_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
