...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    sass: {
      options: {
        ...
        sourceMapRoot: "++theme++{{cookiecutter.project_slug}}theme/css"
      },
      dist: {
        files: {
    ...
    less: {
      plone: {
        options: {
          ...
          sourceMapURL:
            "++theme++{{cookiecutter.project_slug}}theme/css/theme-compiled.less.map",
      ...
      theme: {
        options: {
          ...
          outputSourceFiles: true,
          sourceMapFileInline: false,
          // sourceMapURL: "++theme++{{cookiecutter.project_slug}}theme/css/main.css.map",
  ...
  // CWD to theme folder
  grunt.file.setBase(
    "./src/{{cookiecutter.project_slug}}.theme/src/{{cookiecutter.project_slug}}/theme/theme"
  );
